...
export default function HeroDisplay() {
  ...
  return (
    <div className='main flex place-items-end bg-black bg-cover bg-center p-5 md:px-10 2xl:px-20 bg-img3 my-1 sm:my-0'>
            <div className='flex flex-col gap-4 md:gap-10'>
                <section className='heading flex flex-col md:flex-row'>
                    <h1 className='text-white text-4xl max-w-lg font-bold sm:text-5xl'>PREMIUM CAR RENTAL</h1>
